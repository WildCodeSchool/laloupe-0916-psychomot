...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/PsychomotBundle/Resources/config/doctrine') => 'PsychomotBundle\\Entity'));
